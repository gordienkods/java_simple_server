...
//        String expRes = "{\"sorted_level\":1,\"top\":[{\"7\":\"711\"},{\"6\":\"611\"},{\"5\":\"511\"},{\"4\":\"411\"},{\"3\":\"311\"},{\"2\":\"211\"},{\"1\":\"0\"}]}";
//
//        dataStorage.buildDescTopUsersByLevelResult(20,1);
//        String actRes = dataStorage.getSortedTopUsersByLevelResultAsJson();
//
//        Assert.assertEquals("\nEXP: " + expRes + "\nACT: " + actRes + "\n\n",expRes,actRes);
//    }
...
//        String expRes = "{\"sorted_level\":2,\"top\":[{\"7\":\"622\"},{\"6\":\"622\"},{\"4\":\"422\"},{\"3\":\"322\"},{\"2\":\"0\"},{\"1\":\"0\"},{\"5\":\"0\"}]}";
//
...
//    }
    ...
    public void buildTopUsersInDescOrderByLeve3Result(){
        ...
        for (int i = 0; i < expRes.length(); i++){
                ...
                String actVal = actRes.getJSONObject(i).get(expKey).toString();

            if (expVal.compareTo(actKey) == 0){
